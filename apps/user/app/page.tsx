  ...
  return (
    <div className="landing-bg w-full h-full">
      <div className="header w-full h-[760px] top-[-80px] relative">
        ...
        >
          <div
            className="w-1/3 h-48 absolute top-96 left-[-16.666%]"
            style={{ backgroundColor: "#383d44" }}
          ></div>
          <div
            className="w-1/3 h-48 absolute top-0 right-[16.666%]"
            style={{ backgroundColor: "#2e2e2e" }}
          ></div>
          <div
            className="w-1/3 h-48 absolute right-0 bottom-0"
            style={{ backgroundColor: "#2e2e2e" }}
          ></div>
        </div>
        <div
            ...
            <div className="intro-row flex p-[-15px]">
              <div className="w-1/2">
                <div className="ipad-container mt-[100px]">
                  <div
                    className="ipad w-[414px] h-[284px] bg-white 
                      rounded-[30px] rotate-[-8deg] transition-all duration-400"
                    style={{
                      boxShadow:
                    ...
                    >
                      ...
                      >
                        <div className="ipad-screen-content-left w-3/4 h-full">
                          ...
                          >
                            <div
                              className="ipad-app h-[65px] rounded-[5px] m-[5px]
                                p-[5px]"
                              style={{
                                width: "calc(100% / 4)",
              ...
              <div
                className="w-[50%] h-[100%] flex flex-col items-center  
                  justify-center m-24"
              >
                ...
                <p
                  className="text-white font-normal opacity-50 mt-10 leading-7 
                    text-center text-sm"
                >
                ...
                <button
                  className="shadow-hover rounded-full border-solid border
                    border-blue-b mt-7 px-3 py-[6px] text-white text-sm 
                    font-light bg-blue-b hover:bg-dark-blue-b hover:border 
                    hover:border-dark-blue-b transition-all duration-400"
                >
                  Create Account {">"}
                </button>
              </div>
...
const ListItem: React.FC<{ fill: number; color: string; rest?: string }> = ({
  fill,
  color,
  rest,
}) => {
  return (
    <div
      className={
        "ipad-list bg-white p-[10px] border-solid border-[1px] flex justify-between " +
        rest
      }
...
const ListPanel: React.FC<{ fill: number }> = ({ fill }) => {
  return (
    <div
      className="ipad-panel-list-item w-full h-[5px] mb-2 rounded-[5px]"
      style={{ backgroundColor: "#e3e7ed" }}
    ></div>
  );
};
